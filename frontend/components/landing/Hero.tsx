...
export default function Hero() {
  ...
  return (
    <section
      className="relative flex flex-col items-center w-full bg-[#0A0A0A] pb-16 px-6 md:pb-[100px] md:px-[120px] overflow-hidden"
      style={{ paddingTop: "clamp(96px, 14vh, 180px)" }}
    >
      {/* Headline */}
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#F5F5F0] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="FIND EVERY AI CALL." speed={45} delay={100} />
      </h1>
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#FFD600] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="GOVERN IT INSTANTLY." speed={45} delay={500} />
      </h1>
      ...
      <p className="font-ibm-mono text-[13px] md:text-[15px] text-[#888888] tracking-[1px] leading-[1.6] text-center w-full max-w-[800px]">
        AUTOMATED AI ASSET DISCOVERY FOR SECURITY AND GOVERNANCE TEAMS.
        <br />
        FROM SHADOW LLM CALLS TO FULL COMPLIANCE, IN MINUTES.
      </p>
      ...
      <p className="font-ibm-mono text-[11px] text-[#555555] tracking-[2px] text-center">
        NO CREDIT CARD // SCAN IN UNDER 5 MINUTES // TRUSTED BY SECURITY TEAMS
      </p>
      ...
      >
        <ScanInterfaceSVG mounted={mounted} />
      </div>
    </section>
  );
}
...
const layers = [
  { label: "REPO / ACME-API",     color: "#FFD600", indent: 0,  active: true },
  { label: "OPENAI CLIENT",       color: "#4ADE80", indent: 12 },
  { label: "EMBEDDING CALL",      color: "#60A5FA", indent: 12 },
  { label: "VECTOR STORE",        color: "#60A5FA", indent: 12 },
  { label: "AGENT LOOP",          color: "#FF6B35", indent: 12 },
  { label: "PROMPT TEMPLATE",     color: "#FF6B35", indent: 24 },
  { label: "MODEL CONFIG",        color: "#888",    indent: 24 },
  { label: "FINE-TUNED MODEL",    color: "#4ADE80", indent: 12 },
  { label: "AUDIT LOG",           color: "#888",    indent: 0  },
];

const inspectProps = [
  { key: "PROVIDER",    val: "OPENAI" },
  { key: "MODEL",       val: "GPT-4-TURBO" },
  { key: "FILE",        val: "api/chat.ts" },
  { key: "LINE",        val: "142" },
  { key: "RISK",        val: "HIGH", swatch: "#FF6B35" },
  { key: "STATUS",      val: "ACTIVE", swatch: "#4ADE80" },
  { key: "CONFIDENCE",  val: "98%" },
  { key: "OWNER",       val: "UNASSIGNED" },
];

const tokens = [
  { name: "critical", hex: "#FF6B35" },
  { name: "high", hex: "#FFD600" },
  { name: "medium", hex: "#60A5FA" },
  { name: "low", hex: "#4ADE80" },
  { name: "info", hex: "#555555" },
];
...
const tickerItems = [
  "OPENAI", "ANTHROPIC", "LANGCHAIN", "PINECONE", "HUGGING FACE",
  "AZURE OPENAI", "BEDROCK", "VECTOR DB", "AGENT", "RAG",
];

function ScanInterfaceSVG({ mounted }: { mounted: boolean }) {
  return (
    <>
      ...
      >
        ...
        <text x="12" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">DETECTED ASSETS</text>
        ...
        <text x="912" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">ASSET DETAIL</text>
        ...
        <text x="912" y="300" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">RISK LEVELS</text>
        ...
        <text x="280" y="84" fontFamily="monospace" fontSize="8" fill="#FFD600" letterSpacing={1}>SCAN / acme-api — 1100 FILES</text>
        ...
        <text x="325" y="252" fontFamily="monospace" fontSize="7" fill="#0A0A0A" fontWeight="700" letterSpacing={0.5}>START SCAN</text>
        <rect x="418" y="236" width="90" height="24" fill="none" stroke="#3D3D3D" strokeWidth="1.5" />
        <text x="430" y="252" fontFamily="monospace" fontSize="7" fill="#555" letterSpacing={0.5}>VIEW REPORT</text>
        ...
        <text x="360" y="293" fontFamily="monospace" fontSize="7" fill="#333" letterSpacing={1}>scan-report.json — FLYYY.AI</text>
        ...
        <text x="330" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>9 ASSETS</text>
        <text x="430" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>MONITORING ON</text>
        <text x="600" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>COVERAGE: 94%</text>
        <text x="730" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>v1.0.0</text>
